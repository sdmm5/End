...
<head>
    ...
    <link href="/End/css/t11.css" rel="stylesheet" type="text/css">
    <link href="/End/css/base.css" rel="stylesheet" type="text/css">
</head>
...
<header>
    <div class="top container">
        ...
        <img src="/End/images/12321.gif">
    </div>

    <div role="navigation" class="nav1 navbar navbar-default">
        <div class="container">
            <div class="header-logo">
                <div class="logo-middle"><img src="/End/images/logo.png"></div>
            </div>
    ...
    <div class="nav-bar">
        ...
        <%
            ...
            for (int i = 0; i < titleList.length; i ++){
                if (i == selectNum){
        %>
        <a class="nav-bar-a a-selected" href="/End/u/courseList?type=<%=i%>"><%=titleList[i]%></a>
            <%}else{%>
        <a class="nav-bar-a" href="/End/u/courseList?type=<%=i%>"><%=titleList[i]%></a>
        <%}}%>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                <div class="clearfix">
                    <div class="icon-people"><img src="/End/images/687.png"></div>
                    <div class="text">
